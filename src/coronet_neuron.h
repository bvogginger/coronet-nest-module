...
#ifndef CORONET_NEURON_H
#define CORONET_NEURON_H
...
/* BeginDocumentation
Name: coronet_neuron - Leaky integrate-and-fire neuron model conductance based GABA, AMPA and NMDA synapses.

TODO: change documentation!
Description:
coronet_neuron is an implementation of a spiking neuron using IAF dynamics with
...
namespace mynest
{
  ...
  class coronet_neuron : public nest::Archiving_Node
  {
  ...
  public:        
    ...
    coronet_neuron();
    coronet_neuron(const coronet_neuron&);
    ~coronet_neuron();
  ...
  private:
    ...
    friend class nest::RecordablesMap<coronet_neuron>;
    friend class nest::UniversalDataLogger<coronet_neuron>;
  ...
  private:
     ...
     */
    struct Buffers_ {
      Buffers_(coronet_neuron&);                   //!<Sets buffer pointers to 0
      Buffers_(const Buffers_&, coronet_neuron&);  //!<Sets buffer pointers to 0
  ...
  inline
  nest::port coronet_neuron::connect_sender(nest::CurrentEvent&, nest::port receptor_type)
  {
    if (receptor_type != 0)
      throw nest::UnknownReceptorType(receptor_type, get_name());
    return 0;
  ...
  inline
  nest::port coronet_neuron::connect_sender(nest::DataLoggingRequest& dlr, 
  ...
  inline
  void coronet_neuron::get_status(DictionaryDatum &d) const
  {
    P_.get(d);
    S_.get(d);
  ...
  inline
  void coronet_neuron::set_status(const DictionaryDatum &d)
  {
